...
public class ProyectoNuevoApp {

    private static final Logger log = LoggerFactory.getLogger(ProyectoNuevoApp.class);

    private final Environment env;

    public ProyectoNuevoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes ProyectoNuevo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ProyectoNuevoApp.class);
